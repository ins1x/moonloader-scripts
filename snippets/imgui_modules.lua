...
-- Example: imgui.SetColumnWidth(-1, 77); imgui.CenterColumnText(u8'Р Р°С†РёСЏ'); imgui.NextColumn()
...
--    SampAddChatMessage('Р’С‹ РЅР°Р¶Р°Р»Рё РЅР° РєРЅРѕРїРєСѓ, РїРµСЂРµРјРµРЅРЅР°СЏ СЃРµР№С‡Р°СЃ'..heath.v, -1)
-- end
